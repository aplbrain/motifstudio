        ...
        <Dialog open={isOpen} onClose={onClose} className="relative z-50">
            ...
            <div className="fixed inset-0 overflow-y-auto">
                <div className="flex min-h-full items-center justify-center p-4">
                    <Dialog.Panel className="w-full max-w-4xl rounded-lg bg-white shadow-xl flex flex-col">
                                                                ...
                                                                <div className="mt-3 p-3 bg-gray-100 rounded-md">
                                                                    ...
                                                                    <div className="relative">
                                                                        <div className="max-h-32 overflow-y-auto">
                                                                            <pre className="text-xs text-gray-800 font-mono leading-relaxed whitespace-pre-wrap pr-2">
                                                                                {primitive.dotmotif}
                                                                            </pre>
                                                                        </div>
                                                                        {/* Fade-out for code if it's too long */}
                                                                        {primitive.dotmotif.split("\n").length > 8 && (
                                                                            <div className="absolute bottom-0 left-0 right-0 h-4 bg-gradient-to-t from-gray-100 via-gray-100/80 to-transparent pointer-events-none" />
                                                                        )}
                                                                    </div>
                                                                </div>
                                                            </div>
